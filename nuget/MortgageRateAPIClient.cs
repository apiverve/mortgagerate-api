...
namespace APIVerve.API.MortgageRate
{
    ...
    /// <summary>
    /// Client for the MortgageRate API
    /// </summary>
    public class MortgageRateAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/mortgagerate";
        ...
        {
            { "type", new ValidationRule { Type = "string", Required = true } },
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 1971, Max = 2030 } }
        };
        ...
        public MortgageRateAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MortgageRateAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MortgageRateAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MortgageRateQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MortgageRateQueryOptions options)
        {
        ...
        public ResponseObj Execute(MortgageRateQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MortgageRateQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MortgageRateQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MortgageRateQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MortgageRateQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MortgageRateQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MortgageRateQueryOptions options)
        {
