...
// Request contains the parameters for the Mortgage Rate API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"year": {Type: "integer", Required: false, Min: float64Ptr(1971), Max: float64Ptr(2030)},
	}
...
// ResponseData contains the data returned by the Mortgage Rate API.
