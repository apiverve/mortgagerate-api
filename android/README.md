...
```gradle
dependencies {
    implementation 'com.github.apiverve:mortgagerate-api:1.1.14'
}
```
...
```java
import com.apiverve.mortgagerate.MortgageRateAPIClient;
import com.apiverve.mortgagerate.APIResponse;
import com.apiverve.mortgagerate.APIException;

// Initialize the client
MortgageRateAPIClient client = new MortgageRateAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("type", "30year");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/mortgagerate](https://docs.apiverve.com/ref/mortgagerate)
...
- **Documentation:** [https://docs.apiverve.com/ref/mortgagerate](https://docs.apiverve.com/ref/mortgagerate)
- **Issues:** [GitHub Issues](https://github.com/apiverve/mortgagerate-api/issues)
